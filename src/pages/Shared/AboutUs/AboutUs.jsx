...
const AboutUs = () => {
    return (
        <div className="">
            ...
            <div className="grid w-11/12 md:w-2/6 mx-auto my-5 text-center border-4 border-[#3157ab]/[.3] shadow stats stats-horizontal border-b-[#08153d]/[.8] justify-items-center">
                <div className="stat">
