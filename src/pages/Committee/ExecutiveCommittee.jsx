...
const ExecutiveCommittee = () => {
    ...
    const executive = member.filter(item => item.committee === 'Executive member')
    return (
        <div className="my-14">
            <Helmet>
                <title>NSTUSC | Executive Member</title>
            </Helmet>
            <SectionTitle heading={"Executive Member"}></SectionTitle>
